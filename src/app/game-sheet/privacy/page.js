...
export default function GameSheetPrivacy() {
  return (
        ...
        >
          <div className="space-y-6">
            <h1 className="text-2xl font-bold text-text-light dark:text-text-dark">
              Game Sheet app Privacy Policy
            </h1>
            <div className="space-y-4 text-text-secondary-light dark:text-text-secondary-dark">
              <p>
                Jan Armbrust built the Game Sheet app as a Free app. This SERVICE is provided by Jan Armbrust at no cost and is intended for use as is.
              </p>
              <p>
              ...
              <p>
                The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Game Sheet unless otherwise defined in this Privacy Policy.
              </p>
