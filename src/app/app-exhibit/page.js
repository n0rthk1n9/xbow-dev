...
const iOSUrl = 'https://apps.apple.com/de/app/app-exhibit-your-app-showcase/id6503256642';

export default function AppExhibit() {
  return (
    <main className="container mx-auto min-h-screen px-4 py-8 md:px-8 lg:px-16">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        >
          <div className="space-y-6">
            ...
            <p className="text-text-secondary-light dark:text-text-secondary-dark">
              <strong>To download App Exhibit, just press the download at the App Store button above</strong>
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-text-light dark:text-text-dark">
              I tried to download the App Exhibit App onto my device but it didn't work, what should I do?
            </h2>
            <div className="space-y-4 text-text-secondary-light dark:text-text-secondary-dark">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  If there is less than 100 MB of space available you can try deleting other apps to free up some space. After that just try to download App Exhibit again.
                </li>
                <li>
                  Check your internet connection. To get the best experience, try to connect to a Wifi Network and start the download of App Exhibit again.
                </li>
              ...
              <p>
                ...
                <a href="mailto:appexhibit@xbow.dev" className="text-primary hover:underline">
                  appexhibit@xbow.dev
                </a>
              </p>
            </div>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="space-y-4 text-text-secondary-light dark:text-text-secondary-dark">
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Just open the <strong>App Store</strong> App on your iPhone and search for "App Exhibit". If a new update is available it will show an "Update" button on the App Store page of the app.
                </li>
                <li>
                  The other way is to simply just tap on the App Store button on top of this support page to directly open the App Store page of the App Exhibit App
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-text-light dark:text-text-dark">
              There is something wrong with the App Exhibit App on my phone, I think it has a bug, what should I do?
            </h2>
            <div className="space-y-4 text-text-secondary-light dark:text-text-secondary-dark">
              <ul className="list-disc pl-6 space-y-2">
        ...
        >
          <div className="space-y-4 text-text-secondary-light dark:text-text-secondary-dark">
            <p>
              Thank you for using my app App Exhibit. This means a lot to me. If you still have problems of any kind or you have suggestions on expanding it, don't hesitate to contact me at:{' '}
              <a href="mailto:appexhibit@xbow.dev" className="text-primary hover:underline">
                appexhibit@xbow.dev
              </a>
            </p>
